...
UAV.omega_n_theta = sqrt(UAV.a_theta2+abs(UAV.a_theta3)*UAV.delta_e_max/UAV.e_theta_max);
UAV.zeta_theta = 1;
...
UAV.zeta_V2 = 3;
UAV.ki_V2 = -UAV.omega_n_V2^2/(UAV.a_V3*UAV.K_theta_DC);
UAV.kp_V2 = (UAV.a_V1-2*UAV.zeta_V2*UAV.omega_n_V2)/(UAV.a_V3*UAV.K_theta_DC);

% airspeed with throttle
UAV.omega_n_V = UAV.omega_n_V2;
UAV.zeta_V = 1;
